...
define( 'HOMEO_THEME_VERSION', '1.2.62' );
 ...
 *
 * wp-realestate/assets/js/main.js polls for google.maps.places readiness
 * before wiring up the search-location autocomplete, so it no longer
 * depends on the Maps script loading synchronously.
 *
